...
<div class="row mb-2 ml-1">
	<form action="javascript:void(0)" onsubmit="postGenre()" method="post" id="formulaireAjout">
...
<script type="text/javascript" src="<?php echo Router::webroot('ajax/genreAjax.js');?>"></script>
